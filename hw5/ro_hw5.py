...
Original file is located at
    https://colab.research.google.com/drive/1HTulZlJ3NEnE2_Agd5i3B-FhUQiJEeJL
"""
...
def lin(x0, xf):
    ...
    for (i,), cur_time in np.ndenumerate(time):
        ...
        a[:, i - 1] = (v[:, i] - v[:, i - 1]) * frequency
        x[:, i] = x[:, i - 1] + (v[:, i] + v[:, i - 1]) / 2 * 0.01  # arithmetic mean
